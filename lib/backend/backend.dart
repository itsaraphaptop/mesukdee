...
/// Functions to query JobSubConsRecords (as a Stream and as a Future).
Stream<List<JobSubConsRecord>> queryJobSubConsRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(JobSubConsRecord.collection, JobSubConsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<JobSubConsRecord>> queryJobSubConsRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
