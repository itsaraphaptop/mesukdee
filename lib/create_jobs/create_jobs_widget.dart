...
class CreateJobsWidget extends StatefulWidget {
  const CreateJobsWidget({Key key}) : super(key: key);

  @override
  _CreateJobsWidgetState createState() => _CreateJobsWidgetState();
}
                                ...
                                child: Container(
                                  ...
                                  child: StreamBuilder<List<JobSubConsRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<JobSubConsRecord>
                                          iconButtonJobSubConsRecordList =
                                          snapshot.data;
                                      // Return an empty Container when the document does not exist.
                                      if (snapshot.data.isEmpty) {
                                        return Container();
                                      }
                                      final iconButtonJobSubConsRecord =
                                          iconButtonJobSubConsRecordList
                                                  .isNotEmpty
                                              ? iconButtonJobSubConsRecordList
                                                  .first
